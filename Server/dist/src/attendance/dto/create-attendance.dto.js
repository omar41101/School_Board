...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['present', 'absent', 'late', 'excused'] }),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    ...
    __metadata("design:type", String)
], CreateAttendanceDto.prototype, "subject", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateAttendanceDto.prototype, "academicYear", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['S1', 'S2', 'Summer'] }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsEnum)(['S1', 'S2', 'Summer']),
    __metadata("design:type", String)
], CreateAttendanceDto.prototype, "semester", void 0);
