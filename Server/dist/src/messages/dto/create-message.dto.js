...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, enum: ['low', 'normal', 'high'], default: 'normal' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['low', 'normal', 'high']),
    __metadata("design:type", String)
], CreateMessageDto.prototype, "priority", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, enum: ['academic', 'administrative', 'general', 'urgent'], default: 'general' }),
    (0, class_validator_1.IsOptional)(),
