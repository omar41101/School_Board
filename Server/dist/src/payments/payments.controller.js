...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create payment (Admin only)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(roles_decorator_2.Role.Admin),
    (0, swagger_1.ApiOperation)({ summary: 'Mark payment as paid (Admin only)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(roles_decorator_2.Role.Admin),
    (0, swagger_1.ApiOperation)({ summary: 'Delete payment (Admin only)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
