...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, enum: ['tuition', 'transport', 'library', 'sports', 'exam', 'hostel', 'other'] }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, enum: ['pending', 'paid', 'overdue', 'cancelled', 'refunded'] }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdatePaymentDto.prototype, "remarks", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdatePaymentDto.prototype, "academicYear", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, enum: ['S1', 'S2', 'Summer'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['S1', 'S2', 'Summer']),
    __metadata("design:type", String)
], UpdatePaymentDto.prototype, "semester", void 0);
