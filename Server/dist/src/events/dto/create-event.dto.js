...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['academic', 'sports', 'cultural', 'holiday', 'exam', 'meeting', 'other'] }),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, enum: ['all', 'students', 'teachers', 'parents', 'staff'], default: 'all' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    ...
    (0, class_validator_1.IsArray)(),
    __metadata("design:type", Array)
], CreateEventDto.prototype, "levels", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, enum: ['scheduled', 'ongoing', 'completed', 'cancelled'], default: 'scheduled' }),
    (0, class_validator_1.IsOptional)(),
